About django-storages-feedstock
===============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-storages-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3855&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-storages-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-storages` can be installed with `conda`:
...
```
mamba install django-storages
```

It is possible to list all of the versions of `django-storages` available on your platform with `conda`:
...
```
mamba search django-storages --channel conda-forge
```
...
mamba repoquery search django-storages --channel conda-forge

# List packages depending on `django-storages`:
mamba repoquery whoneeds django-storages --channel conda-forge

# List dependencies of `django-storages`:
mamba repoquery depends django-storages --channel conda-forge
```
